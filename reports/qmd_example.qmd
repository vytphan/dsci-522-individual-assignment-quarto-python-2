...
![Horse populations for all provinces in Canada from 1906 - 1972](../results/horse_pops_plot.png){#fig-horse-pop1 width=70%}

Figure 1: Horse populations for all provinces in Canada from 1906 - 1972.

We can see from Figure @fig-horse-pop1 that Ontario, Saskatchewan and Alberta 
...
We present the standard deviations in Table @horses_sd.
...
Additionally, note that in Table @horses_sd we consider the sample standard deviation of the number of horses during the same time span as Figure 1.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horse-pop2 width=70%}
